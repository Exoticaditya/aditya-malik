...
export default function Contact() {
  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "aditya.malik@example.com",
      link: "mailto:aditya.malik@example.com"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://linkedin.com/in/adityamalik",
      icon: (
    ...
    {
      name: "GitHub",
      url: "https://github.com/adityamalik",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      name: "Twitter",
      url: "https://twitter.com/adityamalik",
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                ...
                or just having a chat about technology. Feel free to reach out through any of the 
                channels below.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {contactInfo.map((info, index) => (
                <div key={index} className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg hover:shadow-md transition-shadow duration-300">
                  ...
                  <div>
                    ...
                    {info.link ? (
                      <a href={info.link} className="text-blue-600 dark:text-blue-400 hover:underline">
                        {info.value}
                      </a>
                    ) : (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 disabled:bg-blue-400 transition-colors duration-300 font-medium flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
